...
check_script_update()
{
    [ "$(md5sum "${BASH_SOURCE[0]}" | awk '{print $1}')" == "$(md5sum <(wget -O - "https://raw.githubusercontent.com/TaoLiuNZ/Xray/main/Xray-TLS%2BWeb-setup.sh") | awk '{print $1}')" ] && return 1 || return 0
}
#更新脚本
update_script()
{
    if wget -O "${BASH_SOURCE[0]}" "https://raw.githubusercontent.com/TaoLiuNZ/Xray/main/Xray-TLS%2BWeb-setup.sh" || wget -O "${BASH_SOURCE[0]}" "https://raw.githubusercontent.com/TaoLiuNZ/Xray/main/Xray-TLS%2BWeb-setup.sh"; then
